            ...
            <Container>
                  ...
                  <Footer>
                        <View style={{ padding: 10, flexDirection: "row", justifyContent: "space-around" }}>
                              ...
                              <View style={styles.button}>
                                    <TouchableOpacity>
                                          <LinearGradient colors={['#8EDD01', '#669B05']} style={{ padding: 20, alignItems: 'center', paddingVertical: 12, borderRadius: 10 }} useAngle={true} angle={200} angleCenter={{ x: 0.5, y: 0.5 }}>
                                                <Typography size={20} color="white" type="extraBold">Approve</Typography>
                                          </LinearGradient>
                                    </TouchableOpacity>
                              </View>
                              ...
                              <View style={styles.button}>
                                    <TouchableOpacity>
                                          <LinearGradient colors={['#F10201', "#C20000"]} style={{ padding: 20, alignItems: 'center', paddingVertical: 12, borderRadius: 10 }} useAngle={true} angle={200} angleCenter={{ x: 0.5, y: 0.5 }}>
