...
export const GetbookingDetails = ()=>(dispatch, getState)=>{
  ...
  let config = {
    ...
    url: 'https://nec-dev-2-k5izze78.it-cpi021-rt.cfapps.in30.hana.ondemand.com/http/Fleetmax/getAllBooking?Transporter_Id=2z',
    headers: { 
    ...
    //  console.log("responsedataaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",response)
            if(response.status==200){
                ...
                dispatch({type:  "BOOKINGDETAILS", payload: response.data.Items[0]})
